...
if __name__ == '__main__':
    ...
    checkpoint_io_img = checkpoints.CheckpointIO(args, model=img_model, optimizer=optimizer_img)
    checkpoint_io_pc = checkpoints.CheckpointIO(args, model=pc_model, optimizer=optimizer_pc)
    try:
